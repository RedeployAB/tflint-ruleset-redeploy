...
- [x] **terraform_locals_mirror_assignment** - Remove direct mirror assignments
  - Simple `Remove()` on the problematic assignment attribute
  - Added comprehensive autofix tests covering single and multiple assignments

### 🔲 To Do

- [ ] **terraform_variable_nullable** - Add explicit `nullable = false`
  - Insert after `type` attribute if present
  - Otherwise insert after variable name
...
| terraform_locals_mirror_assignment | - | ✅ Complete | - |
| terraform_variable_nullable | - | 🔲 Available | - |
