...
This rule validates the placement and spacing of the `tags` argument within
resource blocks. It enforces that:
...
Correct placement and spacing of `tags` help maintain a clean and predictable
structure in resource blocks. It improves readability and ensures that tag
definitions are clearly separated from other configurations.
