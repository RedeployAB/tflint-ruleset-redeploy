...
Redeploy's Terraform rules implement recommendations and enforce best practices
as per the [Terraform documentation](https://www.terraform.io/language). This
ruleset provides a comprehensive set of rules to ensure consistent Terraform
code style and usage across your projects.
